    ...
    subcategories: {
      construction_building: {
        ...
        items: [
          ...
          {
            id: "road_construction_machinery",
            label: "Road Construction Machinery Operation",
          },
      ...
      ict_multimedia: {
        ...
        items: [
          ...
          },
          {
            ...
            label: "Software Programming and Embedded System",
          },
      ...
      energy: {
        ...
        items: [
          ...
          {
            id: "biomass_stoves_l1",
            label: "Biomass and Improved Cooking Stoves L1",
          },
    ...
    subcategories: {
      sciences: {
        ...
        items: [
          ...
          {
            id: "MCE",
            label: "Mathematics - Computer Science - Economics (MCE)",
          },
          {
            id: "MPC",
            label: "Mathematics - Physics - Computer Science (MPC)",
          },
      ...
      humanities: {
        ...
        items: [
          {
            id: "HLP",
            label: "History - Literature in English - Psychology (HLP)",
          },
          {
            id: "HSL",
            label: "History - Geography - Literature in English (HSL)",
          },
        ],
      },
      languages: {
        ...
        items: [
          {
            id: "LFK",
            label:
              "Literature in English - French - Kinyarwanda - Kiswahili (LFK)",
          },
        ],
      },
    },
