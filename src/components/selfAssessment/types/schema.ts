...
export const teachingResourcesSchema = z.object({
    ...
    // Furniture Section
    desks: z.enum(['shared_desks', 'few_desks', 'some_desks', 'most_desks', 'all_desks'], {
        required_error: 'Desk assessment is required',
    }),
    teacherChairs: z.enum(['no_teacher_chair', 'few_teacher_chairs', 'some_teacher_chairs', 'most_teacher_chairs', 'all_teacher_chairs'], {
        required_error: 'Teacher chair assessment is required',
    }),
    teacherTables: z.enum(['no_teacher_table', 'few_teacher_tables', 'some_teacher_tables', 'most_teacher_tables', 'all_teacher_tables'], {
        required_error: 'Teacher table assessment is required',
    }),
    shelves: z.enum(['no_shelves', 'few_shelves', 'some_shelves', 'most_shelves', 'all_shelves'], {
        required_error: 'Shelves assessment is required',
    }),
    dustbins: z.enum(['no_dustbins', 'few_dustbins', 'some_dustbins', 'most_dustbins', 'all_dustbins'], {
        required_error: 'Dustbin assessment is required',
    }),

    // Teaching Staff Section
    sufficientTeachers: z.enum(['lacks_teachers', 'some_teachers', 'all_teachers'], {
    ...
    adminStaffQualification: z.enum(['no_admin_qualification', 'few_admin_qualification', 'some_admin_qualification', 'most_admin_qualification', 'all_admin_qualification'], {
        required_error: 'Admin staff qualification assessment is required',
    }),
    adminStaffAvailability: z.enum(['no_admin_staff', 'few_admin_staff', 'some_admin_staff', 'most_admin_staff', 'all_admin_staff'], {
        required_error: 'Admin staff availability assessment is required',
    }),
    staffFiles: z.enum(['no_staff_files', 'few_staff_files', 'some_staff_files', 'most_staff_files', 'all_staff_files'], {
        required_error: 'Staff files assessment is required',
    }),

    // Strategic Plan Section
    strategicPlan: z.enum(['no_plan', 'basic_plan', 'with_vision', 'with_structure', 'complete_plan'], {
        required_error: 'Strategic plan assessment is required',
    }),
    annualActionPlan: z.enum(['no_action_plan', 'has_action_plan', 'complete_action_plan'], {
        required_error: 'Annual action plan assessment is required',
    }),
    annualBudgetPlan: z.enum(['no_budget_plan', 'has_budget_plan', 'complete_budget_plan'], {
        required_error: 'Annual budget plan assessment is required',
    }),
    registrationDocuments: z.enum(['no_registration', 'has_registration'], {
        required_error: 'Registration documents assessment is required',
    }),
    landOwnership: z.enum(['no_contract', 'rented_facilities', 'rented_clear_terms', 'owned_land'], {
        required_error: 'Land ownership assessment is required',
    }),
});
