...
export const SummaryForm = ({ formData, errors = [] }: SummaryFormProps) => {
  ...
  return (
    <motion.div
      ...
      className="max-w-6xl mx-auto flex-col flex-wrap py-8"
    >
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-y-2 text-sm">
            <div className="flex justify-between border-b pb-1">
              ...
              <p className="font-medium text-right">{formData.schoolName || '—'}</p>
            </div>
            <div className="flex justify-between border-b pb-1">
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-y-2 text-sm">
            <div className="flex justify-between border-b pb-1">
              ...
              <p className="font-medium text-right">{formData.province || '—'}</p>
            </div>
            <div className="flex justify-between border-b pb-1">
              <p className="text-gray-500">District:</p>
              <p className="font-medium text-right">{formData.district || '—'}</p>
            </div>
            <div className="flex justify-between border-b pb-1">
              <p className="text-gray-500">Sector:</p>
              <p className="font-medium text-right">{formData.sector || '—'}</p>
            </div>
            <div className="flex justify-between border-b pb-1">
