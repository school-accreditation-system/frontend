...
const CombinationSelector = ({ onComplete, formData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const selections = selectedCombinations.map(id => combinationDetails[id]);
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-6 max-w-5xl mx-auto">
      ...
      <p className="text-gray-600 mb-6">
        Select academic combinations for {formData?.name || "your school"} to complete the registration
      </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mb-4">Click on a category to view available combinations</p>
