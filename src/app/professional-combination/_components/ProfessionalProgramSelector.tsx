  ...
  programs: [
    {
      ...
      name: "Accounting",
      description:
        "Professional program focused on financial accounting, auditing, and business management. Ideal for careers in finance, consulting, and corporate accounting.",
      subjects: [
    ...
    },
    {
      ...
      description:
        "Healthcare program that prepares students for careers in nursing. Focuses on clinical skills, patient care, and healthcare fundamentals.",
      subjects: [
        "Anatomy & Physiology",
        "Pharmacology",
        "Clinical Nursing",
    ...
    },
    {
      ...
      name: "TTC Subjects",
      description:
        "Teacher Training College program that prepares students for careers in education. Focuses on teaching methodologies and educational fundamentals.",
      subjects: [
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-6 max-w-5xl mx-auto">
      ...
      <p className="text-gray-600 mb-6">
        Select professional programs for {formData?.name || "your institution"}{" "}
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mb-4">
              Select from our professional program offerings
            </p>
        ...
        {selectedPrograms.length === 0 ? (
          ...
          <div className="space-y-3">
            {selectedPrograms.map((id) => {
              const program = PROFESSIONAL_PROGRAMS.programs.find(
                (p) => p.id === id
              );
              return (
                <div
