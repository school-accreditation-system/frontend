...
const DashboardPage = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <h1 className="text-2xl font-bold mb-6 text-blue-500">Inspection Dashboard</h1>
        ...
        <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-blue-500">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-800">{currentYearStats.totalInspections}</h3>
            </div>
        ...
        <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-green-500">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-800">{currentYearStats.completedInspections}</h3>
            </div>
          ...
          <div className="mt-2 flex items-center text-sm">
            <span className="text-green-500 font-medium">{Math.round((currentYearStats.completedInspections / currentYearStats.totalInspections) * 100)}%</span>
        ...
        <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-yellow-500">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-800">{currentYearStats.pendingInspections}</h3>
            </div>
          ...
          <div className="mt-2 flex items-center text-sm">
            <span className="text-yellow-500 font-medium">{currentYearStats.pendingInspections}</span>
        ...
        <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-red-500">
          <div className="flex justify-between items-start">
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-800">{currentYearStats.highRiskSchools}</h3>
            </div>
          ...
          <div className="mt-2 flex items-center text-sm">
            <span className="text-red-500 font-medium">{Math.round((currentYearStats.highRiskSchools / currentYearStats.totalSchools) * 100)}%</span>
      ...
      <div className="bg-white p-4 rounded-lg shadow-md mb-8">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold text-gray-800">Inspection Trends</h2>
