    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">
          Pre Primary Level Application Dashboard
        </h1>
          ...
          <div className="mt-8">
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-semibold text-gray-800">
                  Pre Primary Level Application
                  </h2>
                  <p className="text-gray-500">
                    Apply for Pre Primary Level certification and programs
                  </p>
                </div>
                ...
                >
                  {!hasIdentification
                    ...
                    : hasOrdinaryLevel
                    ? "You already have Pre Primary level"
                    : "Apply for Pre Primary Level"}
                </button>
              </div>
              ...
              {!hasIdentification && (
                <div className="mt-4 bg-yellow-50 border border-yellow-100 rounded-lg p-3">
                  <p className="text-sm text-yellow-700">
                    ...
                    before applying for Pre Primary Level.
                  </p>
                </div>
              )}
            </div>
