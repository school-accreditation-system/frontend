...
const DashboardPage = () => {
  ...
  const recentInspectionsColumns = useMemo(
    () => [
      {
        key: "schoolName" as keyof RecentInspection,
        header: "School Name",
        render: (value: string) => <span className="font-medium">{value}</span>,
      },
      {
        key: "date" as keyof RecentInspection,
        header: "Date",
      },
      {
        key: "status" as keyof RecentInspection,
        header: "Status",
        render: (value: string) => {
      ...
      {
        key: "score" as keyof RecentInspection,
        header: "Score",
      },
      {
        key: "inspector" as keyof RecentInspection,
        header: "Inspector",
      },
    ],
    []
