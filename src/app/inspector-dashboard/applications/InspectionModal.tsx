      ...
      <DialogContent className="sm:max-w-[500px] p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Button
            ...
            className="h-24 flex flex-col items-center justify-center bg-blue-100 hover:bg-primary/90 text-blue-800 border border-blue-300"
            variant="outline"
          >
            <svg
