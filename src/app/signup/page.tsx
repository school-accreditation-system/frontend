                ...
                <div className="flex items-center">
                  <div className="flex-shrink-0 mr-4">
                    ...
                    >
                      <div
                        ...
                        style={{
                          boxShadow:
                            "0 0 0 3px rgba(255,255,255,0.2), 0 2px 4px rgba(0, 0, 0, 0.2)",
                        }}
                      >
                        1
                      </div>
                  ...
                  <div>
                    ...
                    <p className="text-white/80 mt-1">
                      Fill in your personal and professional details to register
                      for a staff account
                    </p>
                  </div>
                </div>
              ...
              <div className="flex mb-12 relative">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 mt-1">
                      Your information will be verified by HR and department
                      administrators
                    </p>
                  </div>
                </div>
              ...
              <div className="flex mb-12 relative">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 mt-1">
                      Once approved, you&apos;ll receive access to the system
            ...
            <div className="lg:hidden">
              ...
              <div className="bg-white/10 rounded-lg p-4 max-w-sm mx-auto">
                <p className="text-white/90 text-center">
                  Fill in your personal and professional details to register for
                  a staff account
                </p>
              </div>
            </div>
